...
define(['./workbox-8fbb88b0'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/^https:\/\/storage\.googleapis\.com\/tfjs-models\/.*/i, new workbox.CacheFirst({
  ...
  workbox.registerRoute(/^https:\/\/unpkg\.com\/.*/i, new workbox.StaleWhileRevalidate({
    "cacheName": "cdn-cache",
    plugins: [new workbox.ExpirationPlugin({
      maxEntries: 20
    })]
